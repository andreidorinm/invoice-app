...
const OblioTab = () => {
  ...
  const openDialogForOblio = () => {
    window.api.setFacturisType('oblio').then(() => {
      ...
      <div className="flex flex-grow overflow-hidden bg-black">
        ...
        <main className="flex-grow p-6 bg-white m-4 rounded-lg shadow-lg">
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold mb-2 text-black">Creeaza NIR Oblio</h3>
